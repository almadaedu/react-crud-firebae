        ...
        <div className="max-w-5xl mx-auto ">
          ...
          <div className="grid grid-cols-4 gap-4 w-full bg-transparent text-slate-50">
            {tools.map((tool) => (
              <div
                key={tool.id}
                className="h-48 l group relative justify-between rounded-md shadow-slate-900 shadow-md p-4 bg-gradient-to-r from-slate-800 to-slate-700"
              >
                <div> 
                ...
                <PencilSquareIcon className='h-6 w-6 text-blue-600 hidden group-hover:block absolute right-4 top-4 cursor-pointer '/>
              </div>
            ))}
          </div>
        </div>
